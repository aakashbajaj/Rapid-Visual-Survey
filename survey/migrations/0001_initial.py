    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hyb_act', models.IntegerField(choices=[(-1, 'Absent'), (1, 'Present'), (0, 'Not Sure')], verbose_name='Hybrid Action')),
                ...
                ('diap_ab', models.PositiveIntegerField(blank=True, choices=[(1, 'Yes'), (0, 'No')], verbose_name='Diaphragm Action Absent?')),
                ('ab_diap', models.PositiveIntegerField(choices=[(1, 'Yes'), (0, 'No')], default=0, verbose_name='Absence of Diaphragms')),
                ('lrg_cut', models.PositiveIntegerField(choices=[(0, 'Absent'), (1, 'Present')], default=0, verbose_name='Large Cut-outs in Diaphragm')),
                ...
                ('pnding', models.PositiveIntegerField(blank=True, choices=[(0, 'Absent'), (1, 'Normal Apparent Condition of Adjacent Building'), (2, 'Poor Apparent Condition of Adjacent Building')], verbose_name='Pounding')),
                ('cnt_bld', models.PositiveIntegerField(choices=[(0, 'Absent'), (1, 'Present')], verbose_name='Contiguous Building')),
